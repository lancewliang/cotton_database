...
package model.entity.sale.country.db.base;
...
/**
  ...
  */
public class Base_SaleMonthSQL{
  ...
  /**
    * code auto write. ready only file. don't change any code. 
    */
  private static final String SQL_INSERT = "insert into SaleMonth (reportDate,country,commodity,source,value,weightUnit,comment,updatedBy,updatedAt) values (?,?,?,?,?,?,?,?,?)";
  private static final String SQL_UPDATE = "update SaleMonth set value=?,weightUnit=?,comment=?,updatedBy=?,updatedAt=? where reportDate=? and country=? and commodity=? and source=?";
  private static final String SQL_DELETE = "delete from SaleMonth where reportDate=? and country=? and commodity=? and source=?";
    
       private static final String SQL_DELETES = "";
    
  public static final String SQL_COLUMS = "sd.reportDate,sd.country,sd.commodity,sd.source,sd.value,sd.weightUnit,sd.comment,sd.updatedBy,sd.updatedAt";
  public static final String SQL_TABLE = "SaleMonth sd";
  ...
  /**
    * code auto write. ready only file. don't change any code. 
    */
 public  static boolean insert(SaleMonth obj) throws SQLException{
    Connection con = null;
    boolean ret = false;
    try{  
      con = getConnection();
 ...
 public  static boolean insert(Connection con,SaleMonth obj) throws SQLException{
   ...
   public static void setInsertValues(PreparedStatement  ps,SaleMonth obj)throws SQLException{
      int col =0;
   ...
   * code auto write. ready only file. don't change any code. 
   */  
   public static boolean update(SaleMonth obj) throws SQLException{
    Connection con = null;
    boolean ret = false;
    try{  
      con = getConnection();
  ...
  public static boolean update( Connection con ,SaleMonth obj) throws SQLException{
    PreparedStatement ps = null;
    try{ 
    ...
    public static void setUpdateValues(PreparedStatement  ps,SaleMonth obj)throws SQLException{
    int col= setValues(ps,obj,0);
     ...
     public static boolean save(SaleMonth obj  ) throws SQLException{
       SaleMonth   _obj =  getObj( 
        obj.getReportDate()  , 
        obj.getCountry()  , 
        obj.getCommodity()  , 
        obj.getSource()  );
      ...
      public static boolean save(List<SaleMonth >objs  ) throws SQLException{
       Connection con = null;
      ...
      for(SaleMonth obj:objs){
      
       SaleMonth   _obj =  getObj(con, 
        obj.getReportDate()  , 
        obj.getCountry()  , 
        obj.getCommodity()  , 
        obj.getSource()  );
...
source
    ...
    PreparedStatement ps = null;
    try{
      LogService.sql(Base_SaleMonthSQL.class, "SQL", SQL_DELETE);
...
source
   ...
   */    
     public static SaleMonth getObj(
          long
reportDate , model.constant.Country
country , model.constant.Commodity
commodity , java.lang.String
source
  ...
  return getObj(conn,
   ...
   DBUtil.cleanup(null, null, conn);
    ...
    public static SaleMonth getObj(Connection conn,
          long
reportDate , model.constant.Country
country , model.constant.Commodity
commodity , java.lang.String
source
      ...
      List<SaleMonth>  list = getObjs(conn,
          reportDate , country , commodity , source
      );  
      if(list.size()==0){
      return null;
      ...
      return (SaleMonth)list.get(0);  
      }
   } 
     
   public static List<SaleMonth> getObjs( Connection conn,
      long
reportDate , model.constant.Country
country , model.constant.Commodity
commodity , java.lang.String
source
    ...
    try{
      ...
      LogService.sql(Base_SaleMonthSQL.class, "SQL", sql);
  ...
  public static int setValues(PreparedStatement ps, SaleMonth obj, int col) throws SQLException{
