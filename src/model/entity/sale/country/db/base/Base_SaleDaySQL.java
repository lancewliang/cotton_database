...
public class Base_SaleDaySQL{
  ...
  /**
    * code auto write. ready only file. don't change any code. 
    */
  private static final String SQL_INSERT = "insert into SaleDay (reportDate,country,commodity,source,total,weightUnit,comment,updatedBy,updatedAt) values (?,?,?,?,?,?,?,?,?)";
  private static final String SQL_UPDATE = "update SaleDay set total=?,weightUnit=?,comment=?,updatedBy=?,updatedAt=? where reportDate=? and country=? and commodity=? and source=?";
  private static final String SQL_DELETE = "delete from SaleDay where reportDate=? and country=? and commodity=? and source=?";
    
       private static final String SQL_DELETES = "";
    
  public static final String SQL_COLUMS = "sd.reportDate,sd.country,sd.commodity,sd.source,sd.total,sd.weightUnit,sd.comment,sd.updatedBy,sd.updatedAt";
  public static final String SQL_TABLE = "SaleDay sd";
  ...
  /**
    * code auto write. ready only file. don't change any code. 
    */
 public  static boolean insert(SaleDay obj) throws SQLException{
    Connection con = null;
    boolean ret = false;
    try{  
      con = getConnection();
 ...
 public  static boolean insert(Connection con,SaleDay obj) throws SQLException{
   ...
   public static void setInsertValues(PreparedStatement  ps,SaleDay obj)throws SQLException{
      int col =0;
   ...
   * code auto write. ready only file. don't change any code. 
   */  
   public static boolean update(SaleDay obj) throws SQLException{
    Connection con = null;
    boolean ret = false;
    try{  
      con = getConnection();
  ...
  public static boolean update( Connection con ,SaleDay obj) throws SQLException{
    PreparedStatement ps = null;
    try{ 
    ...
    public static void setUpdateValues(PreparedStatement  ps,SaleDay obj)throws SQLException{
    int col= setValues(ps,obj,0);
     ...
     public static boolean save(SaleDay obj  ) throws SQLException{
       SaleDay   _obj =  getObj( 
        obj.getReportDate()  , 
        obj.getCountry()  , 
        obj.getCommodity()  , 
      ...
      public static boolean save(List<SaleDay >objs  ) throws SQLException{
       Connection con = null;
      ...
      for(SaleDay obj:objs){
      
       SaleDay   _obj =  getObj(con, 
        obj.getReportDate()  , 
        obj.getCountry()  , 
        obj.getCommodity()  , 
        obj.getSource()  );
...
source
    ...
    PreparedStatement ps = null;
    try{
      LogService.sql(Base_SaleDaySQL.class, "SQL", SQL_DELETE);
...
source
  ...
  return getObj(conn,
   ...
   DBUtil.cleanup(null, null, conn);
    ...
    public static SaleDay getObj(Connection conn,
          long
reportDate , model.constant.Country
country , model.constant.Commodity
commodity , java.lang.String
source
      ...
      List<SaleDay>  list = getObjs(conn,
          reportDate , country , commodity , source
      );  
      if(list.size()==0){
      return null;
      ...
      return (SaleDay)list.get(0);  
      }
   } 
     
   public static List<SaleDay> getObjs( Connection conn,
      long
reportDate , model.constant.Country
country , model.constant.Commodity
commodity , java.lang.String
source
    ...
    try{
      ...
      LogService.sql(Base_SaleDaySQL.class, "SQL", sql);
  ...
  public static int setValues(PreparedStatement ps, SaleDay obj, int col) throws SQLException{
