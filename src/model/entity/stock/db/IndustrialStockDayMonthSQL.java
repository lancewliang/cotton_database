...
import model.entity.stock.db.base.Base_IndustrialStockDayMonthSQL;
import model.entity.weather.db.base.Base_WeatherDaySQL;
import tcc.utils.None;
import tcc.utils.db.DBUtil;
import tcc.utils.log.LogService;

public class IndustrialStockDayMonthSQL extends Base_IndustrialStockDayMonthSQL implements MonthlyQuery, SaveDB {
  ...
  public static int getLastDay(Commodity commodity, Country country, String source) throws SQLException {
    ...
    try {
      conn = getConnection();
      String sql = "select max(reportDate) from IndustrialStockDayMonth WHERE commodity = ? and country = ? and source =? ";
  ...
  public boolean save(List<Record> objs) throws SQLException {
    ...
    for (Record ob : objs) {
      list.add((IndustrialStockDayMonth) ob);
    }
