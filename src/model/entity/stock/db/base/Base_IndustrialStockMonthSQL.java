...
/**
  ...
  */
public class Base_IndustrialStockMonthSQL{
  ...
  /**
    * code auto write. ready only file. don't change any code. 
    */
  private static final String SQL_INSERT = "insert into IndustrialStockMonth (reportDate,country,commodity,source,value,weightUnit,comment,updatedBy,updatedAt) values (?,?,?,?,?,?,?,?,?)";
  private static final String SQL_UPDATE = "update IndustrialStockMonth set value=?,weightUnit=?,comment=?,updatedBy=?,updatedAt=? where reportDate=? and country=? and commodity=? and source=?";
  private static final String SQL_DELETE = "delete from IndustrialStockMonth where reportDate=? and country=? and commodity=? and source=?";
    
       private static final String SQL_DELETES = "";
    
  public static final String SQL_COLUMS = "sm.reportDate,sm.country,sm.commodity,sm.source,sm.value,sm.weightUnit,sm.comment,sm.updatedBy,sm.updatedAt";
  public static final String SQL_TABLE = "IndustrialStockMonth sm";
  public static final String SQL_ALIAS = "sm";
  public static final String SQL_QUERY = "SELECT " + SQL_COLUMS + " FROM " + SQL_TABLE;

  /**
    * code auto write. ready only file. don't change any code. 
    */
 public  static boolean insert(IndustrialStockMonth obj) throws SQLException{
    Connection con = null;
    boolean ret = false;
    try{  
      con = getConnection();
 ...
 public  static boolean insert(Connection con,IndustrialStockMonth obj) throws SQLException{
   ...
   public static void setInsertValues(PreparedStatement  ps,IndustrialStockMonth obj)throws SQLException{
      int col =0;
   ...
   * code auto write. ready only file. don't change any code. 
   */  
   public static boolean update(IndustrialStockMonth obj) throws SQLException{
    Connection con = null;
    boolean ret = false;
    try{  
      con = getConnection();
  ...
  public static boolean update( Connection con ,IndustrialStockMonth obj) throws SQLException{
    PreparedStatement ps = null;
    try{ 
    ...
    public static void setUpdateValues(PreparedStatement  ps,IndustrialStockMonth obj)throws SQLException{
    int col= setValues(ps,obj,0);
     ...
     public static boolean save(IndustrialStockMonth obj  ) throws SQLException{
       IndustrialStockMonth   _obj =  getObj( 
        obj.getReportDate()  , 
        obj.getCountry()  , 
        obj.getCommodity()  , 
        obj.getSource()  );
      ...
      public static boolean save(List<IndustrialStockMonth >objs  ) throws SQLException{
       Connection con = null;
      ...
      for(IndustrialStockMonth obj:objs){
      
       IndustrialStockMonth   _obj =  getObj(con, 
        obj.getReportDate()  , 
        obj.getCountry()  , 
        obj.getCommodity()  , 
        obj.getSource()  );
...
source
    ...
    PreparedStatement ps = null;
    try{
      LogService.sql(Base_IndustrialStockMonthSQL.class, "SQL", SQL_DELETE);
  ...
  public static boolean delete(
     List<IndustrialStockMonth >objs
     ) throws SQLException{
...
source
   ...
   */    
     public static IndustrialStockMonth getObj(
          long
reportDate , model.constant.Country
country , model.constant.Commodity
commodity , java.lang.String
source
  ...
  return getObj(conn,
   ...
   DBUtil.cleanup(null, null, conn);
    ...
    public static IndustrialStockMonth getObj(Connection conn,
          long
reportDate , model.constant.Country
country , model.constant.Commodity
commodity , java.lang.String
source
      ...
      List<IndustrialStockMonth>  list = getObjs(conn,
          reportDate , country , commodity , source
      );  
      if(list.size()==0){
      return null;
      ...
      return (IndustrialStockMonth)list.get(0);  
      }
   } 
     
   public static List<IndustrialStockMonth> getObjs( Connection conn,
      long
reportDate , model.constant.Country
country , model.constant.Commodity
commodity , java.lang.String
source
    ...
    try{
      ...
      LogService.sql(Base_IndustrialStockMonthSQL.class, "SQL", sql);
  ...
  public static int setValues(PreparedStatement ps, IndustrialStockMonth obj, int col) throws SQLException{
