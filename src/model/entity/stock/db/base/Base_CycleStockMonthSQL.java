...
/**
  ...
  */
public class Base_CycleStockMonthSQL{
  ...
  /**
    * code auto write. ready only file. don't change any code. 
    */
  private static final String SQL_INSERT = "insert into CycleStockMonth (reportDate,country,state,commodity,source,value,predictedValue,weightUnit,comment,updatedBy,updatedAt) values (?,?,?,?,?,?,?,?,?,?,?)";
  private static final String SQL_UPDATE = "update CycleStockMonth set value=?,predictedValue=?,weightUnit=?,comment=?,updatedBy=?,updatedAt=? where reportDate=? and country=? and state=? and commodity=? and source=?";
  private static final String SQL_DELETE = "delete from CycleStockMonth where reportDate=? and country=? and state=? and commodity=? and source=?";
    
       private static final String SQL_DELETES = "";
    
  public static final String SQL_COLUMS = "csm.reportDate,csm.country,csm.state,csm.commodity,csm.source,csm.value,csm.predictedValue,csm.weightUnit,csm.comment,csm.updatedBy,csm.updatedAt";
  public static final String SQL_TABLE = "CycleStockMonth csm";
  public static final String SQL_ALIAS = "csm";
  public static final String SQL_QUERY = "SELECT " + SQL_COLUMS + " FROM " + SQL_TABLE;

  /**
    * code auto write. ready only file. don't change any code. 
    */
 public  static boolean insert(CycleStockMonth obj) throws SQLException{
    Connection con = null;
    boolean ret = false;
    try{  
      con = getConnection();
 ...
 public  static boolean insert(Connection con,CycleStockMonth obj) throws SQLException{
   ...
   public static void setInsertValues(PreparedStatement  ps,CycleStockMonth obj)throws SQLException{
      int col =0;
         DBUtil.setLong(ps, ++col,obj.getReportDate());
            DBUtil.setString(ps, ++col, obj.getCountry().getCountry());
              DBUtil.setString(ps, ++col,obj.getState());
   ...
   * code auto write. ready only file. don't change any code. 
   */  
   public static boolean update(CycleStockMonth obj) throws SQLException{
    Connection con = null;
    boolean ret = false;
    try{  
      con = getConnection();
  ...
  public static boolean update( Connection con ,CycleStockMonth obj) throws SQLException{
    PreparedStatement ps = null;
    try{ 
    ...
    public static void setUpdateValues(PreparedStatement  ps,CycleStockMonth obj)throws SQLException{
    int col= setValues(ps,obj,0);
     ...
     public static boolean save(CycleStockMonth obj  ) throws SQLException{
       CycleStockMonth   _obj =  getObj( 
        obj.getReportDate()  , 
        obj.getCountry()  , 
        obj.getState()  , 
        obj.getCommodity()  , 
      ...
      public static boolean save(List<CycleStockMonth >objs  ) throws SQLException{
       Connection con = null;
      ...
      for(CycleStockMonth obj:objs){
      
       CycleStockMonth   _obj =  getObj(con, 
        obj.getReportDate()  , 
        obj.getCountry()  , 
        obj.getState()  , 
        obj.getCommodity()  , 
...
state , model.constant.Commodity
...
source ) throws SQLException{
     ...
     try{  
      con = getConnection();
      con.setAutoCommit(false);
      ret = delete(con, reportDate , country , state , commodity , source);
          con.commit();
      }catch(Exception e){
      try {
        con.rollback(); 
...
source
    ...
    PreparedStatement ps = null;
    try{
      LogService.sql(Base_CycleStockMonthSQL.class, "SQL", SQL_DELETE);
      ps = con.prepareStatement(SQL_DELETE);
     setDelete(   ps ,reportDate , country , state , commodity , source
    ) ;
        ps.executeUpdate();    
     }finally{
      DBUtil.cleanup(ps, null);
...
source
   ...
   */    
     public static CycleStockMonth getObj(
          long
reportDate , model.constant.Country
country , java.lang.String
state , model.constant.Commodity
...
source
   ...
   try{
    conn = getConnection();
  return getObj(conn,
          reportDate , country , state , commodity , source); 
   }finally{
   DBUtil.cleanup(null, null, conn);
    ...
    public static CycleStockMonth getObj(Connection conn,
          long
reportDate , model.constant.Country
country , java.lang.String
state , model.constant.Commodity
...
source
      ...
      List<CycleStockMonth>  list = getObjs(conn,
          reportDate , country , state , commodity , source
      );  
      if(list.size()==0){
      return null;
      ...
      return (CycleStockMonth)list.get(0);  
      }
   } 
     
   public static List<CycleStockMonth> getObjs( Connection conn,
      long
reportDate , model.constant.Country
country , java.lang.String
state , model.constant.Commodity
...
source
    ...
    try{
      ...
      LogService.sql(Base_CycleStockMonthSQL.class, "SQL", sql);
      ...
      while(rs.next()){
       CycleStockMonth  obj = new CycleStockMonth();
        getValues( rs,obj, 0);
  ...
  public static int setValues(PreparedStatement ps, CycleStockMonth obj, int col) throws SQLException{
