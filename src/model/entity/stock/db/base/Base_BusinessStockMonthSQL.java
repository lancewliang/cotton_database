...
/**
  ...
  */
public class Base_BusinessStockMonthSQL{
  ...
  /**
    * code auto write. ready only file. don't change any code. 
    */
  private static final String SQL_INSERT = "insert into BusinessStockMonth (reportDate,country,commodity,source,value,weightUnit,comment,updatedBy,updatedAt) values (?,?,?,?,?,?,?,?,?)";
  private static final String SQL_UPDATE = "update BusinessStockMonth set value=?,weightUnit=?,comment=?,updatedBy=?,updatedAt=? where reportDate=? and country=? and commodity=? and source=?";
  private static final String SQL_DELETE = "delete from BusinessStockMonth where reportDate=? and country=? and commodity=? and source=?";
  ...
  public static final String SQL_TABLE = "BusinessStockMonth sm";
  ...
  /**
    * code auto write. ready only file. don't change any code. 
    */
 public  static boolean insert(BusinessStockMonth obj) throws SQLException{
    Connection con = null;
    boolean ret = false;
    try{  
      con = getConnection();
 ...
 public  static boolean insert(Connection con,BusinessStockMonth obj) throws SQLException{
   ...
   public static void setInsertValues(PreparedStatement  ps,BusinessStockMonth obj)throws SQLException{
      int col =0;
   ...
   * code auto write. ready only file. don't change any code. 
   */  
   public static boolean update(BusinessStockMonth obj) throws SQLException{
    Connection con = null;
    boolean ret = false;
    try{  
      con = getConnection();
  ...
  public static boolean update( Connection con ,BusinessStockMonth obj) throws SQLException{
    PreparedStatement ps = null;
    try{ 
    ...
    public static void setUpdateValues(PreparedStatement  ps,BusinessStockMonth obj)throws SQLException{
    int col= setValues(ps,obj,0);
     ...
     public static boolean save(BusinessStockMonth obj  ) throws SQLException{
       BusinessStockMonth   _obj =  getObj( 
        obj.getReportDate()  , 
        obj.getCountry()  , 
        obj.getCommodity()  , 
        obj.getSource()  );
      ...
      public static boolean save(List<BusinessStockMonth >objs  ) throws SQLException{
       Connection con = null;
      ...
      for(BusinessStockMonth obj:objs){
      
       BusinessStockMonth   _obj =  getObj(con, 
        obj.getReportDate()  , 
        obj.getCountry()  , 
        obj.getCommodity()  , 
        obj.getSource()  );
...
source
    ...
    PreparedStatement ps = null;
    try{
      LogService.sql(Base_BusinessStockMonthSQL.class, "SQL", SQL_DELETE);
...
source
   ...
   */    
     public static BusinessStockMonth getObj(
          long
reportDate , model.constant.Country
country , model.constant.Commodity
commodity , java.lang.String
source
  ...
  return getObj(conn,
   ...
   DBUtil.cleanup(null, null, conn);
    ...
    public static BusinessStockMonth getObj(Connection conn,
          long
reportDate , model.constant.Country
country , model.constant.Commodity
commodity , java.lang.String
source
      ...
      List<BusinessStockMonth>  list = getObjs(conn,
          reportDate , country , commodity , source
      );  
      if(list.size()==0){
      return null;
      ...
      return (BusinessStockMonth)list.get(0);  
      }
   } 
     
   public static List<BusinessStockMonth> getObjs( Connection conn,
      long
reportDate , model.constant.Country
country , model.constant.Commodity
commodity , java.lang.String
source
    ...
    try{
      ...
      LogService.sql(Base_BusinessStockMonthSQL.class, "SQL", sql);
  ...
  public static int setValues(PreparedStatement ps, BusinessStockMonth obj, int col) throws SQLException{
