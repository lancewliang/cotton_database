...
/**
  ...
  */
public class Base_BoursesStockDaySQL{
  ...
  /**
    * code auto write. ready only file. don't change any code. 
    */
  private static final String SQL_INSERT = "insert into BoursesStockDay (reportDate,country,bourse,commodity,source,value,predictedValue,weightUnit,comment,updatedBy,updatedAt) values (?,?,?,?,?,?,?,?,?,?,?)";
  private static final String SQL_UPDATE = "update BoursesStockDay set value=?,predictedValue=?,weightUnit=?,comment=?,updatedBy=?,updatedAt=? where reportDate=? and country=? and bourse=? and commodity=? and source=?";
  private static final String SQL_DELETE = "delete from BoursesStockDay where reportDate=? and country=? and bourse=? and commodity=? and source=?";
  ...
  public static final String SQL_TABLE = "BoursesStockDay bsm";
  ...
  /**
    * code auto write. ready only file. don't change any code. 
    */
 public  static boolean insert(BoursesStockDay obj) throws SQLException{
    Connection con = null;
    boolean ret = false;
    try{  
      con = getConnection();
 ...
 public  static boolean insert(Connection con,BoursesStockDay obj) throws SQLException{
   ...
   public static void setInsertValues(PreparedStatement  ps,BoursesStockDay obj)throws SQLException{
      int col =0;
   ...
   * code auto write. ready only file. don't change any code. 
   */  
   public static boolean update(BoursesStockDay obj) throws SQLException{
    Connection con = null;
    boolean ret = false;
    try{  
      con = getConnection();
  ...
  public static boolean update( Connection con ,BoursesStockDay obj) throws SQLException{
    PreparedStatement ps = null;
    try{ 
    ...
    public static void setUpdateValues(PreparedStatement  ps,BoursesStockDay obj)throws SQLException{
    int col= setValues(ps,obj,0);
     ...
     public static boolean save(BoursesStockDay obj  ) throws SQLException{
       BoursesStockDay   _obj =  getObj( 
        obj.getReportDate()  , 
        obj.getCountry()  , 
        obj.getBourse()  , 
        obj.getCommodity()  , 
      ...
      public static boolean save(List<BoursesStockDay >objs  ) throws SQLException{
       Connection con = null;
      ...
      for(BoursesStockDay obj:objs){
      
       BoursesStockDay   _obj =  getObj(con, 
        obj.getReportDate()  , 
        obj.getCountry()  , 
        obj.getBourse()  , 
        obj.getCommodity()  , 
...
source
    ...
    PreparedStatement ps = null;
    try{
      LogService.sql(Base_BoursesStockDaySQL.class, "SQL", SQL_DELETE);
...
source
   ...
   */    
     public static BoursesStockDay getObj(
          long
reportDate , model.constant.Country
country , model.constant.Bourse
bourse , model.constant.Commodity
...
source
  ...
  return getObj(conn,
   ...
   DBUtil.cleanup(null, null, conn);
    ...
    public static BoursesStockDay getObj(Connection conn,
          long
reportDate , model.constant.Country
country , model.constant.Bourse
bourse , model.constant.Commodity
...
source
      ...
      List<BoursesStockDay>  list = getObjs(conn,
          reportDate , country , bourse , commodity , source
      );  
      if(list.size()==0){
      return null;
      ...
      return (BoursesStockDay)list.get(0);  
      }
   } 
     
   public static List<BoursesStockDay> getObjs( Connection conn,
      long
reportDate , model.constant.Country
country , model.constant.Bourse
bourse , model.constant.Commodity
...
source
    ...
    List<BoursesStockDay> list = new ArrayList<BoursesStockDay>();
    ...
    try{
      ...
      LogService.sql(Base_BoursesStockDaySQL.class, "SQL", sql);
      ...
      while(rs.next()){
       BoursesStockDay  obj = new BoursesStockDay();
        getValues( rs,obj, 0);
  ...
  public static int setValues(PreparedStatement ps, BoursesStockDay obj, int col) throws SQLException{
