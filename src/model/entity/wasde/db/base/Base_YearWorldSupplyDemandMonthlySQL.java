...
/**
  ...
  */
public class Base_YearWorldSupplyDemandMonthlySQL{
  ...
  /**
    * code auto write. ready only file. don't change any code. 
    */
  private static final String SQL_INSERT = "insert into YearWorldSupplyDemandMonthly (country,year,commodity,source,reportDate,reportStatus,beginStock,production,imports,uses,exports,loss,endStock,weightUnit,comment,updatedBy,updatedAt) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
  private static final String SQL_UPDATE = "update YearWorldSupplyDemandMonthly set reportDate=?,reportStatus=?,beginStock=?,production=?,imports=?,uses=?,exports=?,loss=?,endStock=?,weightUnit=?,comment=?,updatedBy=?,updatedAt=? where country=? and year=? and commodity=? and source=?";
  private static final String SQL_DELETE = "delete from YearWorldSupplyDemandMonthly where country=? and year=? and commodity=? and source=?";
    
       private static final String SQL_DELETES = "";
    
  public static final String SQL_COLUMS = "wsd.country,wsd.year,wsd.commodity,wsd.source,wsd.reportDate,wsd.reportStatus,wsd.beginStock,wsd.production,wsd.imports,wsd.uses,wsd.exports,wsd.loss,wsd.endStock,wsd.weightUnit,wsd.comment,wsd.updatedBy,wsd.updatedAt";
  public static final String SQL_TABLE = "YearWorldSupplyDemandMonthly wsd";
  ...
  /**
    * code auto write. ready only file. don't change any code. 
    */
 public  static boolean insert(YearWorldSupplyDemandMonthly obj) throws SQLException{
    Connection con = null;
    boolean ret = false;
    try{  
      con = getConnection();
 ...
 public  static boolean insert(Connection con,YearWorldSupplyDemandMonthly obj) throws SQLException{
   ...
   public static void setInsertValues(PreparedStatement  ps,YearWorldSupplyDemandMonthly obj)throws SQLException{
      int col =0;
   ...
   * code auto write. ready only file. don't change any code. 
   */  
   public static boolean update(YearWorldSupplyDemandMonthly obj) throws SQLException{
    Connection con = null;
    boolean ret = false;
    try{  
      con = getConnection();
  ...
  public static boolean update( Connection con ,YearWorldSupplyDemandMonthly obj) throws SQLException{
    PreparedStatement ps = null;
    try{ 
    ...
    public static void setUpdateValues(PreparedStatement  ps,YearWorldSupplyDemandMonthly obj)throws SQLException{
    int col= setValues(ps,obj,0);
     ...
     public static boolean save(YearWorldSupplyDemandMonthly obj  ) throws SQLException{
       YearWorldSupplyDemandMonthly   _obj =  getObj( 
        obj.getCountry()  , 
        obj.getYear()  , 
        obj.getCommodity()  , 
        obj.getSource()  );
      ...
      public static boolean save(List<YearWorldSupplyDemandMonthly >objs  ) throws SQLException{
       Connection con = null;
      ...
      for(YearWorldSupplyDemandMonthly obj:objs){
      
       YearWorldSupplyDemandMonthly   _obj =  getObj(con, 
        obj.getCountry()  , 
        obj.getYear()  , 
        obj.getCommodity()  , 
        obj.getSource()  );
...
source ) throws SQLException{
     ...
     try{  
      con = getConnection();
      con.setAutoCommit(false);
      ret = delete(con, country , year , commodity , source);
          con.commit();
      }catch(Exception e){
      try {
        con.rollback(); 
...
source
    ...
    PreparedStatement ps = null;
    try{
      LogService.sql(Base_YearWorldSupplyDemandMonthlySQL.class, "SQL", SQL_DELETE);
      ps = con.prepareStatement(SQL_DELETE);
     setDelete(   ps ,country , year , commodity , source
    ) ;
        ps.executeUpdate();    
     }finally{
      DBUtil.cleanup(ps, null);
  ...
  public static boolean delete(
     List<YearWorldSupplyDemandMonthly >objs
     ) throws SQLException{
...
source
   ...
   */    
     public static YearWorldSupplyDemandMonthly getObj(
          model.constant.Country
country , java.lang.String
year , model.constant.Commodity
commodity , java.lang.String
source
  ...
  return getObj(conn,
   ...
   DBUtil.cleanup(null, null, conn);
    ...
    public static YearWorldSupplyDemandMonthly getObj(Connection conn,
          model.constant.Country
country , java.lang.String
year , model.constant.Commodity
commodity , java.lang.String
source
      ...
      List<YearWorldSupplyDemandMonthly>  list = getObjs(conn,
          country , year , commodity , source
      );  
      if(list.size()==0){
      return null;
      ...
      return (YearWorldSupplyDemandMonthly)list.get(0);  
      }
   } 
     
   public static List<YearWorldSupplyDemandMonthly> getObjs( Connection conn,
      model.constant.Country
country , java.lang.String
year , model.constant.Commodity
commodity , java.lang.String
source
    ...
    List<YearWorldSupplyDemandMonthly> list = new ArrayList<YearWorldSupplyDemandMonthly>();
    ...
    try{
      ...
      LogService.sql(Base_YearWorldSupplyDemandMonthlySQL.class, "SQL", sql);
      ...
      while(rs.next()){
       YearWorldSupplyDemandMonthly  obj = new YearWorldSupplyDemandMonthly();
        getValues( rs,obj, 0);
  ...
  YearWorldSupplyDemandMonthly obj,
  ...
  public static int setValues(PreparedStatement ps, YearWorldSupplyDemandMonthly obj, int col) throws SQLException{
