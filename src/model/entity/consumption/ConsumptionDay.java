...
@DB_TABLE(name = "ConsumptionDay", alias = "cd", tablespace = "ccdata")
public class ConsumptionDay extends CommodityRecord implements DaylyRecord , ResetUnit {
