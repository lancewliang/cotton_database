...
/**
  ...
  */
public class Base_ConsumptionMonthSQL{
  ...
  /**
    * code auto write. ready only file. don't change any code. 
    */
  private static final String SQL_INSERT = "insert into ConsumptionMonth (reportDate,country,commodity,source,value,weightUnit,comment,updatedBy,updatedAt) values (?,?,?,?,?,?,?,?,?)";
  private static final String SQL_UPDATE = "update ConsumptionMonth set value=?,weightUnit=?,comment=?,updatedBy=?,updatedAt=? where reportDate=? and country=? and commodity=? and source=?";
  private static final String SQL_DELETE = "delete from ConsumptionMonth where reportDate=? and country=? and commodity=? and source=?";
    
       private static final String SQL_DELETES = "";
    
  public static final String SQL_COLUMS = "cd.reportDate,cd.country,cd.commodity,cd.source,cd.value,cd.weightUnit,cd.comment,cd.updatedBy,cd.updatedAt";
  public static final String SQL_TABLE = "ConsumptionMonth cd";
  ...
  /**
    * code auto write. ready only file. don't change any code. 
    */
 public  static boolean insert(ConsumptionMonth obj) throws SQLException{
    Connection con = null;
    boolean ret = false;
    try{  
      con = getConnection();
 ...
 public  static boolean insert(Connection con,ConsumptionMonth obj) throws SQLException{
   ...
   public static void setInsertValues(PreparedStatement  ps,ConsumptionMonth obj)throws SQLException{
      int col =0;
   ...
   * code auto write. ready only file. don't change any code. 
   */  
   public static boolean update(ConsumptionMonth obj) throws SQLException{
    Connection con = null;
    boolean ret = false;
    try{  
      con = getConnection();
  ...
  public static boolean update( Connection con ,ConsumptionMonth obj) throws SQLException{
    PreparedStatement ps = null;
    try{ 
    ...
    public static void setUpdateValues(PreparedStatement  ps,ConsumptionMonth obj)throws SQLException{
    int col= setValues(ps,obj,0);
     ...
     public static boolean save(ConsumptionMonth obj  ) throws SQLException{
       ConsumptionMonth   _obj =  getObj( 
        obj.getReportDate()  , 
        obj.getCountry()  , 
        obj.getCommodity()  , 
        obj.getSource()  );
      ...
      public static boolean save(List<ConsumptionMonth >objs  ) throws SQLException{
       Connection con = null;
      ...
      for(ConsumptionMonth obj:objs){
      
       ConsumptionMonth   _obj =  getObj(con, 
        obj.getReportDate()  , 
        obj.getCountry()  , 
        obj.getCommodity()  , 
        obj.getSource()  );
...
source
    ...
    PreparedStatement ps = null;
    try{
      LogService.sql(Base_ConsumptionMonthSQL.class, "SQL", SQL_DELETE);
...
source
   ...
   */    
     public static ConsumptionMonth getObj(
          long
reportDate , model.constant.Country
country , model.constant.Commodity
commodity , java.lang.String
source
  ...
  return getObj(conn,
   ...
   DBUtil.cleanup(null, null, conn);
    ...
    public static ConsumptionMonth getObj(Connection conn,
          long
reportDate , model.constant.Country
country , model.constant.Commodity
commodity , java.lang.String
source
      ...
      List<ConsumptionMonth>  list = getObjs(conn,
          reportDate , country , commodity , source
      );  
      if(list.size()==0){
      return null;
      ...
      return (ConsumptionMonth)list.get(0);  
      }
   } 
     
   public static List<ConsumptionMonth> getObjs( Connection conn,
      long
reportDate , model.constant.Country
country , model.constant.Commodity
commodity , java.lang.String
source
    ...
    List<ConsumptionMonth> list = new ArrayList<ConsumptionMonth>();
    ...
    try{
      ...
      LogService.sql(Base_ConsumptionMonthSQL.class, "SQL", sql);
  ...
  public static int setValues(PreparedStatement ps, ConsumptionMonth obj, int col) throws SQLException{
